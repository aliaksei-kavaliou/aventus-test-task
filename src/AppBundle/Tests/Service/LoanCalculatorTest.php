...
class LoanCalculatorTest  extends TestCase
{
    ...
    public function testCalculate()
    {
        ...
        $expected = [
            ['date' => new \DateTime('2017-05-31'), 'mainDebt' => 16322.81, 'interest' => 833.33, 'payed' => 0, 'debt' => 100000],
            ['date' => new \DateTime('2017-06-30'), 'mainDebt' => 16458.83, 'interest' => 697.31, 'payed' => 16322.81, 'debt' => 83677.19],
            ['date' => new \DateTime('2017-07-31'), 'mainDebt' => 16595.99, 'interest' => 560.15, 'payed' => 32781.64, 'debt' => 67218.36],
            ['date' => new \DateTime('2017-08-31'), 'mainDebt' => 16734.29, 'interest' => 421.85, 'payed' => 49377.62, 'debt' => 50622.38],
            ['date' => new \DateTime('2017-09-30'), 'mainDebt' => 16873.74, 'interest' => 282.40, 'payed' => 66111.91, 'debt' => 33888.09],
            ['date' => new \DateTime('2017-10-31'), 'mainDebt' => 17014.35, 'interest' => 141.79, 'payed' => 82985.65, 'debt' => 17014.35],
        ];
